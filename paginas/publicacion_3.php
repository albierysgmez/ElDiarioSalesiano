...
<h1 class="header-title">Promocion 2024</h1>

<div class="meta-publicacion">
    <p class="tema-publicacion"><strong>Tema:</strong> PROMOCION</p>
    <p class="fecha-publicacion">📅 08/12/2025 07:20 PM</p>
</div>

<div class='media-container'><img src='../uploads/1765236003_Capturadepantalla2025-11-08200333.png'></div>

<div class="descripcion-publicacion">dcsc</div>

<div class="like-box">
    <button id="likeToggle" class="like-button" data-id="3" data-liked="">
...
<div class="comentarios-box">
    ...
    <form method='POST' action='../scripts/comentar.php'>
        <input type='hidden' name='id_publicacion' value='3'>
