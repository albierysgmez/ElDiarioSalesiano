...
<h1 class="header-title">jfjfj</h1>

<div class="meta-publicacion">
    <p class="tema-publicacion"><strong>Tema:</strong> DEPORTE</p>
    <p class="fecha-publicacion">📅 07/12/2025 09:09 PM</p>
</div>

<div class='media-container'><img src='../uploads/1765156178_cedula.jpg'></div>

<div class="descripcion-publicacion">nsnsns</div>

<div class="like-box">
    <button id="likeToggle" class="like-button" data-id="2" data-liked="">
